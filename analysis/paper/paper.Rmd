...
Fig. \@ref(fig:plot) gives a pie chart of building energy consumptions.

```{r plot, fig.cap = "Building energy consumptions", fig.width = 5, fig.height = 5, out.width = "60%"}
tar_read(p_end_use)
```
